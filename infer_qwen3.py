"""从本地 Hugging Face Qwen3 目录执行单设备推理。"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="使用本地 Qwen3 safetensors 生成文本。")
...
def main() -> None:
    ...
    print("=" * 80)
    print("Qwen3 单设备推理")
    print(f"device          : {runtime.device_name()} ({runtime.device})")
